...
package BusinessLogic::DeleteAminoAcidProfile;
...
sub _delete_amino_acid_profile
{

	my ($self, $ngstar_type) = @_;
	...
	if($is_valid)
	{
		...
		$value = $self->{_dao}->delete_amino_acid_profile($ngstar_type);
